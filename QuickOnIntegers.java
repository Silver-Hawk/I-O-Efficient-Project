...
//Original version : http://algs4.cs.princeton.edu/23quicksort/Quick.java.html
 ...
 *  @author Kevin Wayne
 */
public class QuickOnIntegers {

    // This class should not be instantiated.
    private QuickOnIntegers() { }
    ...
    public static void sort(Integer[] a) {
        //StdRandom.shuffle(a); remove shuffle
        sort(a, 0, a.length - 1);
        assert isSorted(a);
    }
    ...
    public static Integer select(Integer[] a, int k) {
        ...
        //StdRandom.shuffle(a); -- removed shuffle
